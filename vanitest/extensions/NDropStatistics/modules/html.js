...
const htmlElems = [
  {className:"HtmlDiv", style:{"margin-bottom":"10px"}, children:[
     {className:"HtmlA", href:"https://vanipedia.org/wiki/Special:NDropTrans", text:"ND Translation"},
   ...
   {className:"HtmlDiv", children:[
      {className:"HtmlDiv", cls:"paramblock", children:[
          {className:"HtmlLabel", cls:"paramunit", text:"User:"},
          {className:"HtmlLabel", cls:"paramunit", text:"Language:"},
       ]},
      {className:"HtmlDiv", cls:"paramblock", children:[
         {className:"HtmlSelect", id:"sel_user", cls:"paramunit", onchange:null, populate:(obj)=> appLogic.listUsers(obj)},
         {className:"HtmlSelect", id:"sel_lang", cls:"paramunit", onchange:null, populate:(obj)=> appLogic.listLanguages(obj)}
       ]},
      {className:"HtmlDiv", cls:"paramblock", children:[
      ...
      {className:"HtmlDiv", cls:"paramblock", children:[
         {className:"HtmlSelect", id:"sel_horiz", cls:"paramunit", onchange:null, populate:(obj)=>appLogic.listDimensions(obj,"U")},
         {className:"HtmlSelect", id:"sel_vertic", cls:"paramunit", onchange:null, populate:(obj)=>appLogic.listDimensions(obj,"T")}
       ]},
      {className:"HtmlDiv", cls:"paramblock", children:[
