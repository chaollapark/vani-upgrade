class TblLogic {
  constructor () {
    ...
    this.arrowClasses = {
      ...
      vertic:["fa-arrow-right","fa-arrow-left"]
    };
  }
  
  getStatistics() {
    const url = "/w/extensions/CPStatistics/src/util.php?func=getStatistics";
    ...
    this.parentElem.innerHTML = "Generating statistics ...";
    
    let params = new FormData();
    params.append("petal", sel_petal.value);
    params.append("nspace", sel_nspace.value);
