<?php
/**
 * Vaniversity LocalSettings.php — MediaWiki 1.43 LTS (Docker upgrade)
...
$wgEmergencyContact = "webservant@vaniversity.org";
$wgPasswordSender   = "webservant@vaniversity.org";
...
# Appearance
#----------------------------------------------------------------------
$wgLogo    = '/w/images/Vaniversity-logo-small.png';
...
$wgHooks['BeforePageDisplay'][] = function ( OutputPage &$out, Skin &$skin ) {
	...
	$script = '
		<link rel="stylesheet" type="text/css" href="https://vanipedia.org/editmenu/css/fonts.css?version=33">
