...
private static function SyncPageLang ($id) {
  ...
  $sql = 
    "update vaniquotes.vaniquotes_page p ".
    "set p.page_lang = ".
  ...
  $sql = 
    ...
    "where l.lang_show = 0 ".
    "and l.lang_code = ".
    "  (select p.page_lang from vaniquotes.vaniquotes_page p ".
    "   where p.page_id = $id) ";
  self::$mysqli->query($sql);
}
...
private static function DbConnect () {
  ...
  if (!self::$config) self::$config = require '/var/www/vaniquotes/vaniquotes.env.php';
