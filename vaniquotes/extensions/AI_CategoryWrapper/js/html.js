...
const htmlElems = [
  {className:"HtmlDiv", cls:"border", children: [
     {className:"HtmlButton", id:"btn_categories", cls:"tab_button", text:"Categories", tooltip:"View Categories", onclick:()=>appLogic.selectTab("categories")}
   ]},
  {className:"HtmlDiv", id:"div_categories", cls:"tab_content border", children:[
     {className:"HtmlDiv", children:[
        ...
        {className:"HtmlDiv", cls:"headerblock", children:[
           {className:"HtmlSelect", id:"sel_petl", cls:"headerunit", disabled:1, onchange:()=>ctgLogic.getCategories(true), populate:(obj)=>appLogic.getPetals(obj)},
           {className:"HtmlInput", id:"inp_filt_catg", type:"Text", cls:"headerunit", style:{margin:0}, onchange:()=>ctgLogic.getCategories(true)}
         ]},
        {className:"HtmlDiv", cls:"headerblock", children:[
        ...
        {className:"HtmlDiv", cls:"headerblock", children:[
           {className:"HtmlSelect", id:"sel_rpp", cls:"headerunit", onchange:()=>ctgLogic.getCategories(true), populate:(obj)=>appLogic.getRPP(obj)},
           {className:"HtmlSelect", id:"sel_mtyp", cls:"headerunit", onchange:()=>ctgLogic.getCategories(true), populate:(obj)=>appLogic.getMatchTypes(obj)},
         ]},
        {className:"HtmlDiv", cls:"headerblock", children:[
            {className:"HtmlLabel", cls:"headerunit", text:"Pages From:"},
            {className:"HtmlLabel", cls:"headerunit", text:"Pages Until:"},
         ]},
        {className:"HtmlDiv", cls:"headerblock", children:[
           {className:"HtmlInput", id:"inp_pages_from", type:"Number", cls:"headerunit", min:"0", value:"0", onchange:()=>ctgLogic.getCategories(true)},
           {className:"HtmlInput", id:"inp_pages_until", type:"Number", cls:"headerunit", min:-1, value:"-1", onchange:()=>ctgLogic.getCategories(true)}
         ]},
        {className:"HtmlDiv", cls:"headerblock", children:[
           {className:"HtmlDiv", cls:"headerunit", children:[
              {className:"HtmlLabel", text:"Include:", style:{"margin-right":"10px"}},
              {className:"HtmlSelect", id:"sel_include", onchange:()=>ctgLogic.getCategories(true), populate:(obj)=>appLogic.getIncludeValues(obj)},
           ]},
           {className:"HtmlDiv", cls:"headerunit", children:[
     ...
     {className:"HtmlDiv", id:"div_tbl_categories"}
   ]}
];
