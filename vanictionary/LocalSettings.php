<?php
/**
 * Vanictionary LocalSettings.php — MediaWiki 1.43 LTS (Docker upgrade)
...
$wgEmergencyContact = "webservant@vanictionary.org";
$wgPasswordSender   = "webservant@vanictionary.org";
...
# Appearance
#----------------------------------------------------------------------
$wgLogo    = '/w/images/Vanictionary-logo-small.png';
...
#----------------------------------------------------------------------
# Inline dropdown menus hook (replaces HeadScript)
#----------------------------------------------------------------------
