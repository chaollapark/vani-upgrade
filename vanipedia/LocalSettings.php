<?php
/**
 * Vanipedia LocalSettings.php — MediaWiki 1.43 LTS (Docker upgrade)
...
$wgEmergencyContact = "webservant@vanipedia.org";
$wgPasswordSender   = "webservant@vanipedia.org";
...
$wgRightsUrl  = "http://www.vanipedia.org/wiki/Vanipedia:Copyright";
...
#----------------------------------------------------------------------
# Google Analytics — inline hook (placeholder GA ID, keep commented)
# Uncomment and replace G-XXXXXXX with actual GA4 Measurement ID
#----------------------------------------------------------------------
